...
//		}
	...
	public JwtResponse<Users> updateUser(String donorId, UsersRequest user, HttpServletRequest request) {
		...
		if (userResponse != null) {
			...
			userResponse.setAttempts(0);userResponse.setUpdatedAt(new Date());
	...
	@Override
	public UsersRequest getDonorInfo(int userId) {
		ObjectMapper objectMapper = new ObjectMapper();
		objectMapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false);
		UsersRequest userInfo =objectMapper.convertValue(this.userRepo.getUserDetails(userId),new TypeReference<UsersRequest>() {});
		
		return userInfo;
	}

	@Override
	public long getDonorCunt() {
		// TODO Auto-generated method stub
		return this.userRepo.getDonorCount();
	}
